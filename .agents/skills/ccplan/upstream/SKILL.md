...
> 공통: .claude/guides/common_guide.md | 상세 가이드: .claude/skills/ooplan/references/guide.md
...
- GSD: `ooplan run`↔`/gsd:plan-phase [N]`(옵션 `--research`), `ooprd clarify`↔`/gsd:discuss-phase [N]`, `ooplan check --fix`↔`/gsd:plan-milestone-gaps`. 차이: OAIS는 `d{SP}0002_plan.md` / GSD는 `.planning/phases/N/PLAN.md`. 조합: references/guide.md §4.9
