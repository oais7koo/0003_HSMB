---
name: ccword
description: "공통: `.claude/guides/common_guide.md` | 가이드: `.claude/skills/ccword/references/guide.md`"
---

<!-- ccporting:generated-from-upstream -->
<!-- 원본 Claude 스킬은 upstream/ 폴더에 보관된다. -->

> 공통: `.claude/guides/common_guide.md` | 가이드: `.claude/skills/ccword/references/guide.md`
...
| 구분 | 경로 |
|------|------|
| 스킬 정의 | `.claude/skills/ccword/SKILL.md` |
| 변환 스크립트 | `.claude/skills/ooreport/scripts/ooreport_md2docx.py` |
| 견적서 변환기 | `.claude/skills/ccword/templates/quotation_docx.js` |
| 견적서 스타일 | `.claude/skills/ccword/templates/quotation_docx.json` |
| 가이드 | `.claude/skills/ccword/references/guide.md` |
