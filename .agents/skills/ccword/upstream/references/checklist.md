...
| C03 | python-docx 설치 | Word 문서 생성 라이브러리 | CRITICAL |
| C04 | 템플릿 존재 | Word 템플릿 파일 존재 | WARNING |
| C05 | ooreport 연동 | ooreport 스킬 의존성 확인 | WARNING |
