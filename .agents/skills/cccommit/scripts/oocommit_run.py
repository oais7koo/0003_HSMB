...
# scripts/ -> cccommit/ -> skills/ -> .claude/ -> PROJECT_ROOT
...
def print_usage():
    ...
    print()
    print("예시:")
    print("    python .claude/skills/cccommit/scripts/oocommit_run.py run")
    print(
        '    python .claude/skills/cccommit/scripts/oocommit_run.py commit --message "fix: 버그 수정"'
    )
    print("    python .claude/skills/cccommit/scripts/oocommit_run.py preview")
