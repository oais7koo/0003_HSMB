---
name: ccpdf
description: "공통: `.claude/guides/common_guide.md` | 관련: `.claude/skills/ooreport/SKILL.md`"
---
...
실행: `uv run python .claude/skills/ccpdf/scripts/oopdf_run.py [args]`
...
> 체크리스트: `.claude/skills/ccpdf/references/checklist.md`
