...
사용법:
    uv run python .agents/skills/ccfeature/scripts/oofeature_validate.py
    uv run python .agents/skills/ccfeature/scripts/oofeature_validate.py --sp 04
    uv run python .agents/skills/ccfeature/scripts/oofeature_validate.py --sp 04 --verbose
    uv run python .agents/skills/ccfeature/scripts/oofeature_validate.py --dry-run
"""
...
def main():
    ...
    if not args or args[0] in ("help", "-h", "--help"):
        ...
        print("  --sp N       특정 SP 지정 (기본값: 현재 cccontext SP)")
