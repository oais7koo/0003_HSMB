...
사용법:
    ...
    uv run python .claude/skills/oofeature/scripts/oofeature_validate.py --sp 04
    uv run python .claude/skills/oofeature/scripts/oofeature_validate.py --sp 04 --verbose
    uv run python .claude/skills/oofeature/scripts/oofeature_validate.py --dry-run
"""
...
def run_validate(sp: str, verbose: bool = False):
    ...
    print(f"[oofeature validate] SP{sp.zfill(2)}\n")
...
def run_dry_run(sp: str):
    docs = scan_detail_docs(sp)
    print(f"[oofeature validate --dry-run] SP{sp.zfill(2)}")
