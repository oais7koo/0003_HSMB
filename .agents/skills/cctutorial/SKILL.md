---
name: cctutorial
description: "OAIS 프로젝트의 Claude 환경, oo 스킬, SC 명령어, 플러그인에 대한 튜토리얼 문서를 생성·관리한다 | 출력: `00_doc/tutorial/`"
---
...
실행: `uv run python .claude/skills/cctutorial/scripts/ootutorial_run.py`
...
`.claude/skills/cctutorial/scripts/ootutorial_run.py` | `.claude/skills/oohelp/SKILL.md` | `00_doc/tutorial/README.md`
