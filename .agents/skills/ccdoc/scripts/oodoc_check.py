...
사용법:
    uv run python .agents/skills/ccdoc/scripts/oodoc_check.py
    uv run python .agents/skills/ccdoc/scripts/oodoc_check.py sp04
    uv run python .agents/skills/ccdoc/scripts/oodoc_check.py --fix
"""
...
# 프로젝트 루트: scripts/ → ccdoc/ → skills/ → .codex/ → D:/1_oo/
