...
명령어:
    ...
    ootest run [시나리오ID] 특정 시나리오 실행 (예: TC-001, UI-LOGIN-001)
    ootest run [카테고리]   카테고리별 실행 (예: 로그인, API, E2E)
    ootest run [우선순위]   우선순위별 실행 (P0, P1, P2, P3)
    ootest preview          테스트 계획 출력 (실행 안함)
"""
...
def print_usage():
    ...
    print("ootest - 통합 테스트 도구")
    print()
    print("사용법:")
    print("    ootest run              전체 테스트 실행")
    print("    ootest run [시나리오ID] 특정 시나리오 실행 (예: TC-001)")
    print("    ootest run [카테고리]   카테고리별 실행 (예: 로그인, API)")
    print("    ootest run [우선순위]   우선순위별 실행 (P0, P1, P2, P3)")
    print("    ootest preview          테스트 계획 출력 (실행 안함)")
    print("    ootest preview [필터]   필터링된 테스트 계획")
    print()
    print("옵션:")
    ...
    print()
    print("예시:")
    print("    python .claude/skills/ootest/scripts/ootest_run.py run")
    print("    python .claude/skills/ootest/scripts/ootest_run.py run TC-001")
    print("    python .claude/skills/ootest/scripts/ootest_run.py run P0")
    print("    python .claude/skills/ootest/scripts/ootest_run.py preview")
