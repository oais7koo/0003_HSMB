---
name: cctest
description: "참조: common_guide.md (에이전트) | oocontext.md (SP) | 상세: `references/guide.md`"
---
...
TDD RED + 테스트 작성 + 반복 실행. 컨텍스트: `--sp N` 또는 `oocontext N`. 문서연계: 실패→d{SP}0004 / 개발→d{SP}0002 / 항목→d{SP}0003. 역할분리(oodev=INIT/GREEN/REFACTOR vs cctest=RED/실행/갱신/Part D 재스캔): `references/guide.md` §2.
