# -*- coding: utf-8 -*-
# ################################################################################
# Title: ccscrap sync - 등록 채널 신규 영상 동기화
# Author: ookoo
# Date: 2026.04.03
# Version: v01
...
def parse_args():
    parser = argparse.ArgumentParser(description="ccscrap sync - 채널 신규 영상 동기화")
...
def main():
    ...
    print(f"\n{'='*60}")
    print("ccscrap sync - 등록 채널 신규 영상 동기화")
    print(f"{'='*60}")
