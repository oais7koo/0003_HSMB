...
| 스킬 | 처리 방식 |
|------|----------|
| cccheck | 에러를 현재 SP의 todo 문서에 등록 |
| **ccfix** | **SP!=00: `d{SP}0004` + `d0004` 둘 다 확인/수정** |
| ccdev | 현재 SP의 todo 문서 사전 검토 |
| cchistory | 현재 SP의 todo -> history 아카이브 |

> **ccfix 예외**: 수정 작업은 공통 모듈(oo)에도 영향을 줄 수 있으므로 d0004도 함께 처리
...
- `.codex/guides/common_guide.md`, `CLAUDE.md`
