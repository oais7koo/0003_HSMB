...
| 명령어 | 설명 |
|--------|------|
| `cchelp help` | 서브명령어 목록 표시 |
| `cchelp version` | 스킬 버전 정보 (v03) |
| `cchelp status` | 서브명령어 리스트, 현재 상태 |
| `cchelp check` | references/checklist.md 기반 체크 및 리포팅 | 터미널 |
| `cchelp run` | 도움말 생성 |
| `cchelp show checklist` | 역할 수행 체크리스트 표시 | 터미널 |
