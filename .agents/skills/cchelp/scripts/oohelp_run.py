...
Usage:
    uv run .claude/skills/cchelp/scripts/oohelp_run.py           # 전체 스킬 목록
    uv run .claude/skills/cchelp/scripts/oohelp_run.py oodev   # 특정 스킬 상세
    uv run .claude/skills/cchelp/scripts/oohelp_run.py --json    # JSON 출력
"""
...
def print_skill_list(skills: list[dict]) -> None:
    ...
    print("---")
    print()
    print("**상세 도움말**: `uv run .claude/skills/cchelp/scripts/oohelp_run.py [스킬명]`")
