---
name: ccsidi
description: "01_obsidian/ 볼트의 마크다운 문서 생성·편집·검색·구조 관리 스킬 | ref: `.claude/guides/common_guide.md`"
---
...
| **하지 않는 것** | 연구노트(→oonote), 프로젝트 문서(→oodoc), 소개서 작성(→ccsidi [소개서]) |
...
실행: `uv run python .claude/skills/ccsidi/scripts/oosidi_run.py [args]`
...
`.claude/skills/ccsidi/scripts/oosidi_run.py` | `.claude/skills/oodoc/SKILL.md` | `01_obsidian/`
