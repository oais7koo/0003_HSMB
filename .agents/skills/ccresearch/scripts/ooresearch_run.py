#!/usr/bin/env python3
"""
ooresearch_run.py - ccresearch 스킬 스크립트 (SOTA 기반 연구 수행)
Usage: uv run python .claude/skills/ccresearch/scripts/ooresearch_run.py [help|version|status]
"""
import sys
