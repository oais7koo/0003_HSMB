...
### cctodo vs oofix 역할 구분

- **cctodo**: d0004의 "대기 ToDo" 섹션을 관리. 사용자가 직접 추가한 할 일을 처리하며, 코딩(oodev 위임)과 비코딩(문서, 분석 등 직접 처리) 모두 대응하는 **범용 할 일 관리자**.
...
실행: `uv run python .claude/skills/cctodo/scripts/ootodo_run.py [args]`
...
| 8 | 문서, oodoc, d0001~d0010 | `ccdoc` | `ccdoc run` |
...
> **관련 문서**: `.claude/skills/cctodo/references/guide.md` | `.claude/skills/cctodo/templates/ootodo_template.md` | `.claude/skills/oodev/SKILL.md` | `.claude/skills/oohistory/SKILL.md` | `00_doc/d{SP}0004_todo.md` 외
