...
명령어:
    cclib run              전체 모듈 분석
    cclib run [모듈명]     특정 모듈 분석 (예: cclib run company)
    cclib update           d0005_lib.md 문서 업데이트
"""
...
def print_usage():
    ...
    print("cclib - oo 모듈 분석 및 문서화")
    print()
    print("사용법:")
    print("    cclib run              전체 모듈 분석")
    print("    cclib run [모듈명]     특정 모듈 분석 (예: company, db)")
    print("    cclib update           d0005_lib.md 문서 업데이트")
    print()
    print("옵션:")
    ...
    print()
    print("예시:")
    print("    python .claude/skills/cclib/scripts/oolib_update.py run")
    print("    python .claude/skills/cclib/scripts/oolib_update.py run company")
    print("    python .claude/skills/cclib/scripts/oolib_update.py update")
