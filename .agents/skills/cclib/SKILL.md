...
실행: `uv run python .claude/skills/cclib/scripts/oolib_run.py [args]`
...
`cclib doc --compact` 또는 `oodoc run --compact` 호출 시 적용. guide.md 템플릿보다 우선:
