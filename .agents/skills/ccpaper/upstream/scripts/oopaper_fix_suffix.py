...
사용법:
    uv run python .claude/skills/oopaper/scripts/oopaper_fix_suffix.py [--folder ID] [--batch] [--dry-run] [--lang en|ko]
...
def cmd_fix_suffix(args) -> int:
    ...
    if args.dry_run:
        ...
        print(f"\n다음 단계: `oopaper update --lang {args.lang}` — paper_list 동기화")
    return 0
