---
name: ccreview
description: "참조: .codex/guides/common_guide.md | .agents/skills/cccontext/SKILL.md"
---

<!-- ccporting:generated-from-upstream -->
<!-- 원본 스킬은 upstream/ 폴더에 보관된다. -->

> 참조: .codex/guides/common_guide.md | .agents/skills/cccontext/SKILL.md
> 결과: 리뷰 이슈 → d{SP}0004_todo.md | 상세 리뷰 → 터미널 출력
> 상세 체크리스트: .agents/skills/ccreview/references/checklist.md
...
| PR 전 종합 리뷰 | `ccreview run` → `cccommit run` |
