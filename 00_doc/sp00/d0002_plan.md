...
| R09 | ps1301(45GB) 전수 IQA 산출 시 GPU·디스크 시간 과다 | 중 | ✅ 해결 — 가로·세로 가운데 50% center crop으로 처리 영역을 원본의 25%로 축소(d3020 R08) + 이미지 단위 체크포인트. E3-2 737장 4.9h 완주 |
