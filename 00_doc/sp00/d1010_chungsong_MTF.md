...
| **총 조건 수** | 50개 폴더 |
| **총 이미지 수** | 520장 (조건당 평균 10.4장, 범위 7~13) — ISO1600 평탄화 반영 |
| **이미지 형식** | PNG |
...
### 4.2 조건별 이미지 수 (조건 폴더 직속 frame, 2026-05-17 실측 집계)

| 거리 | ISO100 | ISO200 | ISO400 | ISO800 | ISO1600 | 소계 |
|------|--------|--------|--------|--------|---------|------|
| 2.5m | 12+8 | 10+8 | 12+9 | 12+10 | 11+10 | 102장 |
| 3.5m | 12+8 | 12+9 | 11+8 | 12+10 | 12+11 | 105장 |
| 4.5m | 10+9 | 12+10 | 12+9 | 12+9 | 13+10 | 106장 |
| 5.5m | 11+7 | 12+9 | 13+8 | 12+10 | 12+9 | 103장 |
| 6.5m | 11+8 | 12+10 | 12+8 | 13+9 | 12+9 | 104장 |
| **합계** | | | | | | **520장** |

> 각 셀: 60 km/h장 + 80 km/h장. `frame_*.png` 직속 전수 집계 (ISO1600 조건 `MTF 50/` 평탄화 반영).
> ISO별 합계: ISO100=96, ISO200=104, ISO400=102, ISO800=109, ISO1600=109 (총 520).
...
| 파일 유형 | 수량 | 설명 |
|-----------|------|------|
| frame PNG (원본) | 520장 | 조건 폴더 직속, 분석 대상 (ISO1600 평탄화 반영) |
...
| 실험 | 내용 |
|------|------|
| **E1-1: NR-IQA 측정** | 520장 frame → HSMB + 비교 NR-IQA 6종 스코어 산출 |
