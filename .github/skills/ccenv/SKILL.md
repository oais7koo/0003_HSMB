...
- `00_doc/sp00/d0009_env.md`를 입력 기준으로 삼아 Copilot에서 실제로 쓸 수 있는 항목과 아닌 항목을 구분한다.
- 결과를 `00_doc/sp00/d0009_ccenv.md`에 기록한다.

## Subcommands

- `run`: Copilot 환경 기준 사용 가능/부분 가능/사용 불가 항목을 분석해 `00_doc/sp00/d0009_ccenv.md`를 생성한다.
...
- `sp00/d0009_env.md`는 있는데 Copilot 세션 관점의 문서가 따로 필요할 때

## Procedure

1. 먼저 `00_doc/sp00/d0009_env.md`를 기준 문서로 읽는다.
...
5. 결과를 `00_doc/sp00/d0009_ccenv.md`에 Markdown 문서로 저장한다.
