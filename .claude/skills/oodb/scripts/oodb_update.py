...
명령어:
    oodb run        전체 DB 분석 및 문서화
    oodb schema     스키마만 추출 (출력)
    oodb update     d0006_db.md 문서 업데이트
"""
...
def print_usage():
    ...
    print("oodb - DB 스키마 분석 및 문서화")
    print()
    print("사용법:")
    print("    oodb run        전체 DB 분석 및 문서화")
    print("    oodb schema     스키마만 추출 (출력)")
    print("    oodb update     d0006_db.md 문서 업데이트")
    print()
    print("옵션:")
    ...
    print()
    print("예시:")
    print("    python .claude/skills/oodb/scripts/oodb_update.py run")
    print("    python .claude/skills/oodb/scripts/oodb_update.py schema")
    print("    python .claude/skills/oodb/scripts/oodb_update.py update --export-words")
