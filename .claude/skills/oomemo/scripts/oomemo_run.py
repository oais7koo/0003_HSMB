#!/usr/bin/env python3
"""
oomemo_run.py - oomemo 스킬 스크립트 (임시 메모 읽기/쓰기)
Usage: uv run python .claude/skills/oomemo/scripts/oomemo_run.py [w|r|run|help|version|status] [내용]
"""
import sys
...
def cmd_no_args():
    ...
    print("  oomemo r          → 메모 읽기")
    print("  oomemo w [내용]   → 메모 덮어쓰기")
    print("  oomemo run [지시] → 읽기/쓰기 자동 판단")
