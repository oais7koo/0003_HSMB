---
name: oocontext
description: "서브프로젝트 컨텍스트 관리 스킬 'oocontext', '컨텍스트 전환', 'SP 설정' 등을 요청할 때 트리거된다"
metadata:
  version: "v09"
  category: "meta-util"
---

# oocontext - 서브프로젝트 컨텍스트 관리
...
| 명령어 | 설명 |
|--------|------|
| `oocontext status` | 서브명령어 리스트, 현재 상태 |
| `oocontext check` | references/checklist.md 기반 체크 및 리포팅 | 터미널 |
| `oocontext run` | 컨텍스트 전환 실행 (sp_config.json 자동 갱신 포함) | 터미널 |
| `oocontext show checklist` | 역할 수행 체크리스트 표시 | 터미널 |
| `oocontext add checklist "항목"` | 체크리스트 항목 추가 | checklist.md |
| `oocontext` | 현재 컨텍스트 확인 |
| `oocontext [N]` | SP N으로 설정 (00~09) |
| `oocontext clear` | 공통(00) 초기화 |
| `oocontext list` | SP 목록 표시 |
| `oocontext load [경로]` | 프로젝트 구조/종속성/메타데이터 수집 (load 흡수) |
...
| 조건 | 등록 대상 | 예시 |
|------|----------|------|
| `oocontext` 미지정 (SP=00) | `00_doc/sp00/d0004_todo.md` | d0004 |
| `oocontext 02` (SP=02) | `00_doc/sp02/d20004_todo.md` | d20004 |
| `oocontext 05` (SP=05) | `00_doc/sp05/d50004_todo.md` | d50004 |
