---
name: oosurvey
description: "논문 서베이 및 분석 스킬 'oosurvey', '서베이 생성', '논문 분석', '선행연구 정리' 등을 요청할 때 트리거된다"
model: opus
metadata:
  version: "v07"
  category: "content"
...
| 명령어 | 설명 |
|--------|------|
| `oosurvey help` | 서브명령어 목록 표시 |
| `oosurvey version` | 스킬 버전 정보 (v07) |
| `oosurvey status` | paper 폴더 현황, d0110 상태, 미분석 논문 |
| `oosurvey check` | references/checklist.md 기반 체크 및 리포팅 | 터미널 |
| `oosurvey show checklist` | 역할 수행 체크리스트 표시 | 터미널 |
| `oosurvey add checklist "항목"` | 체크리스트 항목 추가 | checklist.md |
...
| `oosurvey compare` | 논문 간 비교 분석 (모델, 성능, 방법론) |
...
> **관련 문서**: `00_doc/sp00/d0001_prd.md` | `00_doc/sp00/d0110_survey.md` | `00_doc/sp00/d0004_todo.md` | `.claude/skills/oosurvey/references/guide.md`
...
| `.claude/skills/oosurvey/references/guide.md` | 상세 가이드 |
