...
SKILL_NAME = "oosurvey"
SKILL_VERSION = "v07"
SKILL_DOC = ".claude/skills/oosurvey/SKILL.md"
...
SUBCOMMANDS = [
    ...
    "oosurvey list --recent N",
    "oosurvey list --search KEYWORD",
    "oosurvey run",
    "oosurvey run --topic TOPIC",
    "oosurvey run --topic TOPIC --output FILE",
    "oosurvey run --paper-dir PATH",
    "oosurvey deeprun",
    "oosurvey compare",
    "oosurvey cite --format FORMAT",
    "oosurvey add FOLDER",
]
...
def cmd_run(args: list):
    ...
    if not topic:
        ...
        print("**예시:**")
        print("```bash")
        print('oosurvey run --topic "딥러닝 기반 크랙 탐지"')
        print("```")
        return
