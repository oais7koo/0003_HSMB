...
def main():
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ['-h', '--help']:
        print("Usage: uv run .claude/skills/oodoc/scripts/oodoc_md_to_docx.py <input.md> [output.docx]")
        print("       oodoc run md <input.md>")
        print("")
        print("Markdown to DOCX 변환 (oodoc 기본 스타일 적용)")
        print("  - 폰트: 맑은 고딕, 10pt")
        print("  - 줄간격: 0.92")
