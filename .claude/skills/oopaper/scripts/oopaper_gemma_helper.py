...
def task_summary_draft(paper_text: str, caller: str = "oopaper") -> str:
...
def task_translate_page(english_page: str, caller: str = "oopaper") -> str:
...
def task_rephrase(text: str, instruction: str, caller: str = "oopaper") -> str:
