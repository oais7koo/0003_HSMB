...
사용법:
    uv run python .claude/skills/oopaper/scripts/oopaper_extend.py [--folder ID] [--dry-run] [--limit N] [--source all|arxiv|s2]
"""
...
USER_AGENT = "Mozilla/5.0 (compatible; oopaper-extend/1.0; academic research)"
...
def do_extend(args):
    ...
    print("# oopaper extend - 참고문헌 확장 수집\n", flush=True)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="oopaper extend - 서머리 외부 참고문헌 검색·다운로드"
    )
