...
사용법:
    uv run python .claude/skills/oopaper/scripts/oopaper_doctor.py [--check NAME] [--lang en|ko]
...
def cmd_doctor(args):
    ...
    print(f"# oopaper doctor — 종합 진단 (v01)")
...
def main():
    parser = argparse.ArgumentParser(description="oopaper 종합 정합성 진단 (읽기 전용)")
