---
name: oosync
description: "Vibe 환경 동기화 스킬 'oosync', '동기화', '프로젝트 동기화', 'vibe 동기화' 등을 요청할 때 트리거된다"
metadata:
  version: "v14"
  category: "meta-util"
---

# oosync - Vibe 환경 동기화 (바이브셋 동기화)
...
**루트 설정**: CLAUDE.md, .mcp.json, .claudeignore, cclaude.bat, cclaude.sh, gemma.ps1, gemma.sh
...
| 템플릿 형식 준수 | 각 명령어별 템플릿(`.claude/skills/oosync/templates/oosync_*.md`) 형식 따름 |
