...
# 프로젝트 루트 (oosync 스킬 기준 4단계 상위)
PROJECT_ROOT = Path(__file__).resolve().parents[4]
CONFIG_PATH = PROJECT_ROOT / ".claude" / "skills" / "oosync" / "references" / "ftp_config.json"
...
def cmd_help():
    """도움말"""
    print("# oosync ftp - SP별 FTP 동기화\n")
    print("사용법: oosync ftp <command> [SP] [--dry-run]\n")
    ...
    print()
    print("설정: .claude/skills/oosync/references/ftp_config.json")
