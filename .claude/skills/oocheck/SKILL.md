...
> 상세 가이드: .claude/skills/oocheck/references/guide.md
...
- v04 2026-04-07 — oocheck run dXXXX 추가 — 상세 문서 기반 관련 코드만 체크
...
| oocheck oo / error / term | oo모듈 / 에러 / 표준용어 체크 |
| oocheck debug [에러] | 심층 디버깅 (troubleshoot 흡수) |
...
용어집: .claude/skills/oocheck/templates/oocheck_standard_word.md
...
**조합 패턴:** `oodev run` → `oocheck run` → `/gsd:verify-work`
