...
def print_usage():
    ...
    print("oostop - 세션 종료 워크플로우")
    print()
    print("사용법:")
    print("    oostop run        2단계 종료 워크플로우 실행 (기본)")
    print("    oostop readme     README.md 업데이트만 수행 (1단계)")
    print("    oostop sync       doc/*.md 동기화만 수행 (2단계)")
    print()
    print("옵션:")
    ...
    print()
    print("예시:")
    print("    python .claude/skills/oostop/scripts/oostop_run.py run")
    print("    python .claude/skills/oostop/scripts/oostop_run.py readme --message \"로그인 기능 구현\"")
...
def cmd_sync(options):
    ...
    if HISTORY_FILE.exists():
        ...
        if today not in content:
            ...
            print("  [TIP] oohistory run 으로 이력을 추가하세요.")
        else:
