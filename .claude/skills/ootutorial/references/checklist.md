# ootutorial check 체크리스트

> ootutorial 스킬 자체 건강 상태 검증 항목
...
| C03 | tutorial 디렉터리 | 00_doc/tutorial/ 존재 | ERROR |
| C04 | 인덱스 파일 | tutorial/index.md 존재 | WARNING |
| C05 | 스킬 문서 연동 | 각 스킬 튜토리얼 파일 존재 | INFO |
