"""oopdf - PDF 변환/처리 스킬 (MD→PDF, PDF→Image)"""
import subprocess
import sys
import sys as _sys
...
def cmd_show_checklist():
    ...
    if not checklist_path.exists():
        print(f"[oopdf] checklist.md 없음: {checklist_path}")
        return
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='oopdf - Markdown to PDF converter')
