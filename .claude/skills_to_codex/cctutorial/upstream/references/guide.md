...
| 튜토리얼 출력 템플릿 | `.claude/skills/ootutorial/templates/tutorial_skill_template.md` | `.claude/tutorial/skills/*.md` 생성 시 사용하는 표준 구조 템플릿 |

**운영 원칙**
1. 스킬 생성/문서화와 직접 연결된 템플릿은 가능한 한 `ootutorial` 스킬 폴더 내부에 둔다.
2. 일반 튜토리얼 독자용 산출물은 `.claude/tutorial/` 아래에 둔다.
...
2. [개요] .claude/tutorial/00_overview.md 생성
...
| C03 | .claude/tutorial/ 디렉토리 존재 | ERROR |
...
| `.claude/tutorial/README.md` | 전체 튜토리얼 인덱스 |
