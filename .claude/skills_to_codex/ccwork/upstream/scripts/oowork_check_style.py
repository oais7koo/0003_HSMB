"""oowork 개조식(S01) 종결어미·마커 검증 스크립트.
...
Reference: .claude/skills/oowork/references/checklist_common.md (G20·G21·G25·G26)
           .claude/skills/oowork/references/writing_styles.md (S01)
...
def check_file(path: Path, strict: bool) -> int:
    ...
    print(f"# oowork 개조식(S01) 검증 — {path}")
    print()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="oowork 개조식(S01) 검증")
