#!/usr/bin/env python3
"""
ooresearch_run.py - ooresearch 스킬 스크립트 (SOTA 기반 연구 수행)
Usage: uv run python .claude/skills/ooresearch/scripts/ooresearch_run.py [help|version|status]
"""
import sys
