...
## 문서 이력 관리
- v17 2026-05-18 — 섹션 5.5/6.2: d0008 프로젝트 체크리스트(oocheck 관할) 등록
...
> **스킬 체크리스트 ↔ 프로젝트 체크리스트 구분**: 위 `oo*/references/checklist.md`는 **스킬 고유** 체크리스트로 특정 프로젝트와 무관하다. 반면 **프로젝트 전용** 체크리스트는 `d{SP}0008_checklist.md`(oocheck 관할)에 별도 관리한다 — `oocheck add "내용"`으로 항목 추가(성격별 코드 자동부여), `oocheck run`으로 d0008 + 선택 스킬 체크리스트를 일괄 체크.
...
├── d0008_checklist.md    # SP00 프로젝트 체크리스트 (oocheck 관할)
